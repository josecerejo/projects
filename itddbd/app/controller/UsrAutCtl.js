        ...
        Ext.Ajax.request({
            ...
            success: function(RspJSN){
                ...
                if (Rsp.success === true) {
                    ...
                    Frm.down('container').update('<div style="text-align:center"><p><b>' + UsrNme + '</b> is not authorized to the IT Dashboard</p><p>Please submit an IT Request for access to <b>' + PgmNme + '</b></p>');
