...
Ext.define('Ptl.controller.UsrAutCtl', {
        ...
        if (Frm.isValid()) {
            Frm.submit({
                ...
                success: function(Frm, Acn) {
                    ...
                    if (SveCrl){
                        if (!Rcd) {
                            Rcd = Ext.create('Ptl.model.UsrInf');
