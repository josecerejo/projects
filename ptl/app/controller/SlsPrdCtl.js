...
Ext.define('Ptl.controller.SlsPrdCtl', {
        ...
        if (SlsPrdTab.title == 'Product') {
            Ext.Ajax.request({
                ...
                success: function(Rsp){
                    Inf = Ext.JSON.decode(Rsp.responseText);
                    //            window.open('http://dev:10080' + Inf.Pth + 'CusInvT3XLS.php?FleNme=' + Inf.FleNme);
                    DwnLodFrm = Ext.fly('DwnLodFrm').dom;
                    DwnLodFrm.action = "data/CusInvT3XLS.php?FleNme=" + Inf.FleNme;
                    DwnLodFrm.submit();            
                }
            });
        }
            ...
            Ext.Ajax.request({
                ...
                success: function(Rsp){
                    Inf = Ext.JSON.decode(Rsp.responseText);
                    //            window.open('http://dev:10080' + Inf.Pth + 'CusInvT6XLS.php?FleNme=' + Inf.FleNme);
                    DwnLodFrm = Ext.fly('DwnLodFrm').dom;
                    DwnLodFrm.action = "data/CusInvT6XLS.php?FleNme=" + Inf.FleNme;
                    DwnLodFrm.submit();            
                }
            });
        }
            ...
            Ext.Ajax.request({
                ...
                success: function(Rsp){
                    Inf = Ext.JSON.decode(Rsp.responseText);
                    //            window.open('http://dev:10080' + Inf.Pth + 'CusInvT4XLS.php?FleNme=' + Inf.FleNme);
                    DwnLodFrm = Ext.fly('DwnLodFrm').dom;
                    DwnLodFrm.action = "data/CusInvT4XLS.php?FleNme=" + Inf.FleNme;
                    DwnLodFrm.submit();            
                }
            });
        }
    ...
    PrsAxsEvt: function(Lbl, Evt, Opt) {
        ...
        var Ctl = Ptl.getApplication().getController('SlsQdrCtl');
    ...
    PTcMstLod: function(Sto) {
        var Rcd = Ext.create('Ptl.model.PTcMst');
    ...
    PGrMstLod: function(Sto) {
        var Rcd = Ext.create('Ptl.model.PGrMst');
    ...
    PSbMstLod: function(Sto) {
        var Rcd = Ext.create('Ptl.model.PSbMst');
    ...
    PSzMstLod: function(Sto) {
        var Rcd = Ext.create('Ptl.model.PSzMst');
    ...
    AcMDivLod: function(Sto) {
        var Rcd = Ext.create('Ptl.model.AcMDiv');
    ...
    AcMSegLod: function(Sto) {
        var Rcd = Ext.create('Ptl.model.AcMSeg');
    ...
    AcMRgnLod: function(Sto) {
        var Rcd = Ext.create('Ptl.model.AcMRgn');
    ...
    AcMMgrLod: function(Sto) {
        var Rcd = Ext.create('Ptl.model.AcMMgr');
